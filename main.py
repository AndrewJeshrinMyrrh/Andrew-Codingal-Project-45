...
tk.Label(window, text="Enter Principle ", width="10", font=("helvetica", 12, "bold"), padx="5", pady="5", bg="blue", fg="white").place(x=10, y=10)
tk.Label(window, text="Enter Rate ", width="10", font=("helvetica", 12, "bold"), padx="5", pady="5", bg="blue", fg="white").place(x=10, y=50)
tk.Label(window, text="Enter Time ", width="10", font=("helvetica", 12, "bold"), padx="5", pady="5", bg="blue", fg="white").place(x=10, y=90)
p=tk.IntVar()
r=tk.IntVar()
t=tk.IntVar()
